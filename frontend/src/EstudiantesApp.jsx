...
export default function EstudiantesApp({ onLogout }) {
  ...
  const handleSubmit = async (e) => {
    ...
    dataToSend.append("carrera", formData.carrera);
    dataToSend.append("promedio", formData.promedio);
    ...
    try {
      ...
      document.getElementById("form-estudiantes").reset(); 
      cargarEstudiantes();
  ...
  const columnas = [
    ...
    { name: "Carrera", selector: (row) => row.carrera, sortable: true },
    {
      ...
      cell: (row) => 
        row.foto ? (
          <img 
            src={`http://localhost:8000${row.foto}`} 
            alt="Carpeta Media" 
            width="50" 
            height="50" 
        ...
        <div className="col-md-4 mb-4">
          <div className="card shadow-sm">
            ...
            <div className="card-body">
              ...
              <form id="form-estudiantes" onSubmit={handleSubmit}>
                <div className="mb-3">
